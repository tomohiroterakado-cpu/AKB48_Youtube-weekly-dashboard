...
function tablePlan({ sheet, headerRow = 3, requiresWeekStart = true, keyForRecord, keyForRow, records, apply }) {
  return { sheet, headerRow, requiresWeekStart, keyForRecord, keyForRow, records, apply };
}
