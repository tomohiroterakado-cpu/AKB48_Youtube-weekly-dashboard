...
function buildImageEditPrompt(production) {
  ...
  return [
    "You are designing only the graphic treatment and an uncluttered composition area for an existing Japanese YouTube thumbnail.",
    ...
    "Do not place faces, logos, important objects, letters, numbers, or any glyphs inside the text-safe area. Keep it visually calm and suitable for direct typography, without creating a banner, base panel, ribbon, plaque, or caption plate.",
    ...
    "Improve only the editable areas: restrained decorative accents, moderate metallic highlights, subtle gloss, clean depth, and calm negative space for the direct typography when needed.",
