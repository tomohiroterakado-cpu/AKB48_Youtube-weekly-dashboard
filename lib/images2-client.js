...
function buildImageEditPrompt(production) {
  ...
  return [
    "You are designing only the background, decorative treatment, and text-safe composition of an existing Japanese YouTube thumbnail.",
    ...
    "Improve only the editable areas: decorative accents, metallic highlights, gloss, depth, and a clean high-contrast lower-third plate for a later text overlay.",
    "Do not render any letters, Japanese characters, English words, numbers, punctuation, or placeholder text. The application adds the exact Japanese telop after generation.",
    "Keep all faces and eyes free from the lower-third plate. Do not change existing official logos. No watermark."
  ].join("\n");
}
