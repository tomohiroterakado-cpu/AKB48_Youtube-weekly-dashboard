...
function canRetryRequest(url, options = {}) {
  ...
  return method === "GET" || method === "PUT" || url.includes("/values:batchUpdate");
}
...
module.exports = { GoogleSheetsRepository, TABLES, cellValue, parseValue, retryDelayMs, retryAfterMs, spreadsheetColumn };
