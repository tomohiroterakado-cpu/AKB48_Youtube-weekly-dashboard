const TABLES = {
  ...
  prepublishReviews: { sheet: "AI_prepublish_reviews", fields: ["id", "createdAt", "channel", "seriesName", "episode", "targetAudience", "currentTitle", "recommendedTitle", "abTitles", "estimatedCtr", "status", "adoptedTitle", "publishedVideoId", "actualCtr", "measuredAt", "analysisVersion", "model"] }
};
