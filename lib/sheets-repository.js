...
class GoogleSheetsRepository {
  ...
  async readFresh({ trackRowIndexes = false } = {}) {
    ...
    const state = { schemaVersion: 1, imports: [], dailyImports: [], videos: [], metrics: [], dailyMetrics: [], classifications: [], reviews: [], members: [], categories: [], marketReports: [], thumbnailGenerations: [], settings: {} };
    const rowIndexes = {};
